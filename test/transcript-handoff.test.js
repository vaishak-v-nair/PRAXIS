// The session reducer and the handoff capsule. Named for `praxis hud` and
// `praxis switch` when both were commands; hud was removed in 0.11.0 but the
// reducer it drove still lives in lib/transcript.js and is still worth its
// tests — the deck and health read the same shapes.
